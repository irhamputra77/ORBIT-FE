import { backendApi, backendErrorResponse, getAuthorizationHeader, apiJson } from "@/lib/http/backendRoute";
...
export async function GET(request: Request) {
  ...
  try {
    const response = await backendApi.get(`/api/service-bulletins?${params.toString()}`, {
